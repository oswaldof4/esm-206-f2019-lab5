...
There is a significant difference in lobster lenghts between Naples and Mohawk Reef (t(df) = statistic, p < 0.001, alpha = 0.005)
...
Here is my t-statistic: `r nm_ttest2$statistic`
